...
import FoodDeletedTable from "./FoodDeletedTable";

const page = () => {
  const [openForm, setOpenForm] = useState(false);
  return (
    <div>
      <BreadcrumbComponent page="Foods" />
      <div className="mt-6 flex justify-between text-sidebar-primary">
        <div className="flex items-center gap-4">
          <h1 className="text-size-3xl">Food List</h1>
          <DropdownMenu>
      ...
      <div className="mt-6">
        <FoodDeletedTable open={openForm} onClose={setOpenForm} />
      </div>
    </div>
  );
};
