...
import TypeBedDeletedTable from "./TypeBedDeletedTable";

const page = () => {
  const [openForm, setOpenForm] = useState(false);
  return (
    <div>
      <BreadcrumbComponent page="TypeBeds" />
      <div className="mt-6 flex justify-between text-sidebar-primary">
        <div className="flex items-center gap-4">
          <h1 className="text-size-3xl">Type Bed List</h1>
          <DropdownMenu>
      ...
      <div className="mt-6">
        <TypeBedDeletedTable open={openForm} onClose={setOpenForm} />
      </div>
    </div>
  );
};
